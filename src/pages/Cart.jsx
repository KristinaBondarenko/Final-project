...
export default function Cart(){
  ...
  return (<div className='container py-8'>
    ...
    <div className='space-y-3'>
      {cart.map(it=>(<div key={it.id} className='card p-3 flex items-center gap-3'>
    ...
    <div className='mt-6 flex items-center justify-between'>
      <div className='text-lg'>Итого: <b>{total.toLocaleString('ru-RU')} руб</b></div>
      <Link to='/checkout' className='btn-primary'>Оформить заказ</Link>
    </div>
  </div>)
}